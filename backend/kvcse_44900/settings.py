"""
Django settings for kvcse_44900 project.
...
WSGI_APPLICATION = "kvcse_44900.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kvcse_44900 API",
    "DESCRIPTION": "API documentation for kvcse_44900 App",
    "VERSION": "v1",
}
